...
class HomeJemput extends StatefulWidget {
  const HomeJemput({super.key});

  @override
  State<HomeJemput> createState() => _HomeJemputState();
}

class _HomeJemputState extends State<HomeJemput>
                ...
                height: 15,
                  ...
                  Row(
                    children: [
                      ...
                      Padding(padding: EdgeInsets.only(left:35)),
                      Image.asset("img/titikjemput.png", scale: 3.0,),
                      Padding(padding: EdgeInsets.only(left:10)),
                      Text("Fasilkom, Indralaya")
                    ],
                  )
